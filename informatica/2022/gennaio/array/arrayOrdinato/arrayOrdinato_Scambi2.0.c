/*Qui non eseguo le iterazioni dove gli scambi sono 0 e dove quindi l'array e gia ordinato*/
...
int main()
{
    ...
    {       
        ...
        if (scambio == 0)
        {
            /*Quando gli scambi effettuati sono zero
            imposto come valore di i direttamente a 
            'ELEMENTI - 1' in questo modo non esegue 
            ulteriori iterazioni inutili*/
            i = ELEMENTI - 1; 
        }
        else
        {
